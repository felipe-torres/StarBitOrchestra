...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        [SerializeField] protected float m_SelectionDuration = 2f;                                // How long it takes for the bar to fill.
        [SerializeField] protected bool m_HideOnStart = true;                                     // Whether or not the bar should be visible at the start.
        [SerializeField] protected Image m_Selection;                                             // Reference to the image who's fill amount is adjusted to display the bar.
        [SerializeField] protected VRInput m_VRInput;                                             // Reference to the VRInput so that input events can be subscribed to.
        

        protected Coroutine m_SelectionFillRoutine;                                               // Used to start and stop the filling coroutine based on input.
        protected bool m_IsSelectionRadialActive;                                                    // Whether or not the bar is currently useable.
        protected bool m_RadialFilled;                                                               // Used to allow the coroutine to wait for the bar to fill.


        public float SelectionDuration { get { return m_SelectionDuration; } }

        public static SelectionRadial Instance { get; set; }
        ...
        protected IEnumerator FillSelectionRadial()
        {

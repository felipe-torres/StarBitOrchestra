...
namespace VRStandardAssets.Utils
{
    ...
    {
        public event Action FadeComplete;                             // This is called when the fade in or out has finished.


        [SerializeField] protected Image m_FadeImage;                     // Reference to the image that covers the screen.
        [SerializeField] protected AudioMixerSnapshot m_DefaultSnapshot;  // Settings for the audio mixer to use normally.
        [SerializeField] protected AudioMixerSnapshot m_FadedSnapshot;    // Settings for the audio mixer to use when faded out.
        [SerializeField] protected Color m_FadeColor = Color.black;       // The colour the image fades out to.
        [SerializeField] protected float m_FadeDuration = 2.0f;           // How long it takes to fade in seconds.
        [SerializeField] protected bool m_FadeInOnSceneLoad = false;      // Whether a fade in should happen as soon as the scene is loaded.
        [SerializeField] protected bool m_FadeInOnStart = false;          // Whether a fade in should happen just but Updates start.

        
        protected bool m_IsFading;                                        // Whether the screen is currently fading.
        protected float m_FadeStartTime;                                  // The time when fading started.
        protected Color m_FadeOutColor;                                   // This is a transparent version of the fade colour, it will ensure fading looks normal.
        ...
        protected virtual IEnumerator BeginFade(Color startCol, Color endCol, float duration)
        {
